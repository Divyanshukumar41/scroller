...
export async function sendOtpEmail({ email, code, purpose }) {
  ...
  try {
    const info = await transport.sendMail({
      ...
      to: email,
      subject: "Your Scroller verification code",
      text: `Your Scroller verification code is ${code}. It expires in 10 minutes.`,
      html: `
        <div style="font-family:Arial,sans-serif;background:#f8fafc;padding:32px">
          <div style="max-width:520px;margin:auto;background:#fff;border:1px solid #e2e8f0;border-radius:20px;padding:32px">
            <h1 style="margin:0 0 8px;color:#312e81">Scroller</h1>
